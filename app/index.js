...
JhipsterGenerator.prototype.askFor = function askFor() {
    ...
    console.log(' \n' +
        ...
        chalk.green('  ██    ██') + chalk.red('  ██    ██     ██     ██             ██     ██     ██        ██   ██\n') +
        chalk.green('   ██████ ') + chalk.red('  ██    ██  ████████  ██        ██████      ██     ████████  ██    ██\n'));
    console.log(chalk.white.bold('                            http://ash.github.io\n'));
    ...
    var defaultAppBaseName = (/^[a-zA-Z0-9_]+$/.test(path.basename(process.cwd())))?path.basename(process.cwd()):'ash';
...
JhipsterGenerator.prototype.projectfiles = function projectfiles() {
    ...
    this.copy('.ash-modules.json', '.ash-modules.json'); // modules will register hooks here
};
