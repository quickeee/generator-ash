...
angular.module('<%=angularAppName%>', ['LocalStorageModule', <% if (enableTranslation) { %>'tmh.dynamicLocale', 'pascalprecht.translate', <% } %>
    ...
    // ash-needle-angularjs-add-module JHipster will add new module here
    'ui.bootstrap', 'ui.router',  'infinite-scroll', 'angular-loading-bar', 'agGrid'])
...
<% } %>
        ...
        // ash-needle-angularjs-add-interceptor JHipster will add new application interceptor here
        <% if (enableTranslation) { %>
    ...
    // ash-needle-angularjs-add-config JHipster will add new application configuration here
