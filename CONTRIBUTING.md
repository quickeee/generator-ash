...
If you find a bug in the source code or a mistake in the documentation, you can help us by submitting a ticket to our [GitHub  issues](https://github.com/ash/generator-ash/issues). Even better, you can submit a Pull Request to our [JHipster generator project](https://github.com/ash/generator-ash) or to our [Documentation project](https://github.com/ash/ash.github.io).

**Please see the Submission Guidelines below**.

## <a name="feature"></a> Feature Requests
You can request a new feature by submitting a ticket to our [GitHub issues](https://github.com/ash/generator-ash/issues). If you
...
* **Entity configuration(s) `entityName.json` files generated in the `.ash` directory** - if the error is during an entity creation or associated with a specific entity
...
* Search [GitHub](https://github.com/ash/generator-ash/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `ash/generator-ash:master`.
...
### Fork the generator-ash project

Go to the [generator-ash project](https://github.com/ash/generator-ash) and click on the "fork" button. You can then clone your own fork of the project, and start working on it.
...
Now, running the 'yo ash' command should use your specific JHipster version. You can test it by making a small change in your cloned generator, and running again on an existing JHipster project:

```shell
yo ash
```

TIP: If this doesn't work, try running `npm link generator-ash` in your project. See [this guide](http://justjs.com/posts/npm-link-developing-your-own-npm-modules-without-tears) for more information.
